...
<tools>
{"type":"function","function":{"name":"computer_use","description":"Use the supplied mobile GUI screenshot. Return coordinates normalized to a 1000 by 1000 reference plane and click the center of UI elements. Some applications take time, so wait and inspect a successive screenshot.","parameters":{"properties":{"action":{"description":"The action to perform.","enum":["key","type","left_click","double_click","scroll","wait","terminate","answer","interact"],"type":"string"},"keys":{"type":"array"},"text":{"type":"string"},"coordinate":{"type":"array"},"pixels":{"type":"number"},"time":{"type":"number"},"status":{"enum":["success","failure"],"type":"string"}},"required":["action"],"type":"object"}}}
</tools>
